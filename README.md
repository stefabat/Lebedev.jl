...
<a href="https://www.codecogs.com/eqnedit.php?latex=I(f)=\int_0^{2\pi}d\phi\int_0^\pi&space;f(\phi,\theta)\sin\theta&space;d\theta\approx4\pi\sum_iw_if(x_i,y_i,z_i)" target="_blank"><img src="https://latex.codecogs.com/svg.latex?I(f)=\int_0^{2\pi}d\phi\int_0^\pi&space;f(\phi,\theta)\sin\theta&space;d\theta\approx4\pi\sum_iw_if(x_i,y_i,z_i)" title="I(f)=\int_0^{2\pi}d\phi\int_0^\pi f(\phi,\theta)\sin\theta d\theta\approx4\pi\sum_iw_if(x_i,y_i,z_i)" /></a>
